<template>
	...
	<div class="pa-0 pos-invoice-shell">
		...
		>
			...
			<div class="dynamic-padding">
				...
				<v-row align="center" class="items px-3 py-2 invoice-topbar">
				...
				<div class="items-table-wrapper">
					...
					<div class="invoice-kpi-strip">
						<v-chip size="small" variant="tonal" color="primary">
							{{ __("Items") }}: {{ items.length }}
						</v-chip>
						<v-chip size="small" variant="tonal" color="secondary">
							{{ __("Recipe Components") }}: {{ packed_items.length }}
						</v-chip>
						<v-chip
							size="small"
							variant="tonal"
							:color="isReturnInvoice ? 'error' : 'success'"
						>
							{{ isReturnInvoice ? __("Return") : __("Sale") }}
						</v-chip>
					</div>
...
.invoice-kpi-strip {
	...
	flex-wrap: wrap;
	padding: 0 var(--pos-space-md) var(--pos-space-sm);
}
