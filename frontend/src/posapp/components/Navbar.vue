...
export default {
	...
	data() {
		...
		items: [
			...
			{ text: "Sales Invoice", icon: "mdi-receipt-outline" },
			{ text: "Purchase Invoice", icon: "mdi-cart-outline" },
			{ text: "Purchase Invoice (New)", icon: "mdi-cart-plus" },
			{ text: "Customers", icon: "mdi-account-group-outline" },
			{ text: "Suppliers", icon: "mdi-store-outline" },
			{ text: "Payments", icon: "mdi-credit-card" },
			{ text: "Sales Return", icon: "mdi-keyboard-return" },
			{ text: "Print", icon: "mdi-qrcode" },
			{ text: "Stock Entries List", icon: "mdi-package-variant-closed" },
			{ text: "Create Stock Entry", icon: "mdi-package-variant" },
			{ text: "Items List", icon: "mdi-format-list-bulleted" },
			{ text: "Create Item", icon: "mdi-tag" },
			{ text: "Recipes", icon: "mdi-chef-hat" },
